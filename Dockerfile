...
RUN echo "http://mirrors.aliyun.com/alpine/v3.6/main" > /etc/apk/repositories \
    ...
    && sed -i'.bak' 's/localhost:3306/119.23.230.86:13306/g' /apollo-quick-start/demo.sh \
    && sed -i'.bak' 's/apollo_config_db_password=/apollo_config_db_password=123456/g' /apollo-quick-start/demo.sh \
    && sed -i'.bak' 's/apollo_portal_db_password=/apollo_portal_db_password=123456/g' /apollo-quick-start/demo.sh \
